...
import org.dbm.dbd.dao.UpdateHisDao;
...
public class UpdateHisService extends BaseService {
     ...
     * 保存操作历史
     */
    public void saveUpdateHis(BaseMongoMap infoMap, Map<String, Object> params) {
        ...
        data.put("userId", BizCommUtil.getLoginUserId());
        data.put("userName", BizCommUtil.getLoginUserName());
