...
import org.dbm.dbd.web.login.CustomWebAuthenticationDetails;
import org.dbm.dbd.web.login.CustomerUserDetails;
import org.dbm.dbd.web.login.UserDetailsServiceImpl;
import org.dbm.dbd.web.util.HttpResponseErrorHandler;
...
public class ThirdLoginController extends BaseController {
    ...
    public String callback(@RequestParam(value = "code", required = false) String code,
        ...
        try {
            ...
            req.getSession().setAttribute(Constants.KEY_USER_ID, ((CustomerUserDetails) userObj).getUserId());
